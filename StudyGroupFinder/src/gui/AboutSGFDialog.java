...
public class AboutSGFDialog extends JDialog implements ActionListener {
	...
	public AboutSGFDialog(GUIFrame parent) {
		...
		String message = "<html><body style='color:rgb(" + colo2 + ");'><h2 style='color:rgb(" + colo + ");'>Study Group Finder</h2><b>Version 0.9</b><br/><br/>Developed by:<ul><li>Michael Kirby</li><li>Bob Filiczkowski</li><li>Mike Claffey</li><li>Robert Jang</li></ul><p width='250px'>Developed for UCSD's CSE 110 class of Fall 2011 taught by Professor William Howden.</p><br/>&copy; 2011 - All Rights Reserved</body></html>";
